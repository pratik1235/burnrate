...
BUILTIN_MILESTONES: List[RawMilestone] = [
    ...
    RawMilestone(
        ...
        bank="hdfc",
        reward_description="₹1,500 voucher (Marriott, Myntra, or Reliance Digital)",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
    RawMilestone(
        title="Annual Spend Bonus (1/2)",
        milestone_type="voucher",
        target_amount=500000,
        period_kind="calendar_year",
        card_template_id="hdfc-regalia-gold",
        bank="hdfc",
        reward_description="Flight vouchers worth ₹5,000",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
    RawMilestone(
        title="Annual Spend Bonus (2/2)",
        milestone_type="voucher",
        target_amount=750000,
        period_kind="calendar_year",
        card_template_id="hdfc-regalia-gold",
        bank="hdfc",
        reward_description="Additional flight vouchers worth ₹5,000",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
    RawMilestone(
        title="Annual Fee Waiver",
    ...
    RawMilestone(
        ...
        bank="onecard",
        reward_description="5X Rewards on your top two spend categories each month",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
    RawMilestone(
        title="Annual Fee Waiver",
        ...
        bank="axis",
        reward_description="₹500 annual fee waived",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
    RawMilestone(
        title="Monthly Lounge Access",
        milestone_type="lounge_access",
        target_amount=20000,
        period_kind="calendar_month",
        card_template_id="scapia",
        bank="federal_scapia",
        reward_description="Unlimited domestic airport lounge access in the following month",
        exclude_categories=json.dumps(["cc_payment"]),
    ),
]
